            ...
            <div className={styles.post}>
                <ul>
                    ...
                    <li className={styles.publications}>
                        ...
                        <img alt="Static Badge" src="https://img.shields.io/badge/VLDB-blue" style={{ marginLeft: '5px' }}></img>
                    </li>
                    ...
                    <li className={styles.publications}>
                        ...
                        <img alt="Static Badge" src="https://img.shields.io/badge/ICASSP-blue" style={{ marginLeft: '5px' }}></img>
                    </li>
                    ...
                    <li className={styles.publications}>
                        ...
                        <img alt="Static Badge" src="https://img.shields.io/badge/arXiv-red" style={{ marginLeft: '5px' }}></img>
                    </li>
                </ul>
            </div>
